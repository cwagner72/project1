...
```js
serviceUrl: URI("http://example.domain.com:50057/sap/opu/odata/sap/XXXX/").directory(),
```

```js
serviceUrl: 'proxy/http/example.domain.com:50057/sap/opu/odata/sap/XXXX/';
```
...
<details>
Disallow override of csap-no-override-storage-prototype (
